...
I build systems at the intersection of **Knowledge Graphs**, **AI Agents**, and **Blockchain**.
...
- How to make AI agents truly context-aware without RAG infrastructure
- Ontology design for heterogeneous data (unified 6 blockchain models into one RDF schema)
- Where traditional finance compliance breaks down on-chain (and how to fix it)
- Whether AI-driven development changes the economics of solo engineering

---

```
Kotlin · Python · TypeScript · SPARQL/RDF · LangGraph · Elasticsearch · Kubernetes · Docker
```
